...
I created comment cards that are wrapped inside of an approal card. The approval card have yes or no buttons. All the styling is done via [semantic.ui](https://semantic-ui.com/).
